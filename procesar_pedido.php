...
if (empty($_SESSION['carrito'])) {
    ...
    $conexion = mysqli_connect("localhost", "root","","caostime")or exit ("no se puede conectar");
    ...
    foreach ($_SESSION['carrito'] as $product_id => $quantity) {
        ...
        $query = "SELECT precio FROM productos WHERE id = $product_id";
    ...
    $insert_query = "INSERT INTO pedidos (nombre, email, direccion, monto_total) VALUES ('$nombre', '$email', '$direccion', $monto_total)";
